...
dependencies {
    // NeoForge
    implementation group: 'net.darkhax.enchdesc', name: 'enchdesc-neoforge-1.21.3', version: '21.3.0'

    // Forge
    implementation group: 'net.darkhax.enchdesc', name: 'enchdesc-forge-1.21.3', version: '21.3.0'

    // Fabric & Quilt
    modImplementation group: 'net.darkhax.enchdesc', name: 'enchdesc-fabric-1.21.3', version: '21.3.0'

    // Common / MultiLoader / Vanilla
    compileOnly group: 'net.darkhax.enchdesc', name: 'enchdesc-common-1.21.3', version: '21.3.0'
}
```
<!-- maven-end -->
