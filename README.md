...
dependencies {
    // NeoForge
    implementation group: 'net.darkhax.enchdesc', name: 'enchdesc-neoforge-1.21.9', version: '21.9.0'

    // Forge
    implementation group: 'net.darkhax.enchdesc', name: 'enchdesc-forge-1.21.9', version: '21.9.0'

    // Fabric & Quilt
    modImplementation group: 'net.darkhax.enchdesc', name: 'enchdesc-fabric-1.21.9', version: '21.9.0'

    // Common / MultiLoader / Vanilla
    compileOnly group: 'net.darkhax.enchdesc', name: 'enchdesc-common-1.21.9', version: '21.9.0'
}
```
<!-- maven-end -->
