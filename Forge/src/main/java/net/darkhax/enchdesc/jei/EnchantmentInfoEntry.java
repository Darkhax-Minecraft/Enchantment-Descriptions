...
public class EnchantmentInfoEntry implements IRecipeCategoryExtension {
    ...
    /**
     * A cache of compatible item enchantments. Built by {@link #buildCompatibilityCache()}, accessed through {@link
     * #getCompatibleItems(Enchantment)}.
     */
    ...
    /**
     * Builds a cache of which enchantments are compatible with which items. Stored in {@link #compatibleItemsCache} and
     * accessed by {@link #getCompatibleItems(Enchantment)}.
     */
