...
public class ConfigurationHandler {
    ...
    public static void syncConfig () {
        ...
        exploreMode = config.getBoolean("exploreMode", config.CATEGORY_GENERAL, false, "Should the mod generate a list of enchantments from the instance that have no description?");
